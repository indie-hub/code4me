...
**Status:** `0.13.2-dev` — actively soaking against real milestones. Public-release prep underway (Phase 1 portability done; Phase 2 community infrastructure landing now).
...
- **[Roadmap](docs/roadmap.md)** — ear-tagged work that's been considered, scoped, and intentionally deferred. Twelve active items as of v0.13.2-dev; explicit trigger conditions on the conditional ones.
